...
{
    public List<LabTagType> GetTags() => [LabTagType.Conversation, LabTagType.ChatHistory, LabTagType.Tools, LabTagType.Mcp, LabTagType.MultiAgent, LabTagType.UserInteraction];
